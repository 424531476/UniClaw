...
**允许操作的 Skill**:
- 位于项目 `skills/` 目录下,且由本技能创建的 Skill
...
2. **检查已有 Skill**
   使用 `Glob` 查找 `skills/*.md` 和 `skills/*/skill.md`,使用 `Read` 读取内容,判断:
   - 是否已存在功能相似的 Skill?
   - 已有 Skill 是否需要改进?
